...
class FinishCrowdfunding extends Command
{
     ...
     * @var string
     */
    protected $signature = 'corn:finish-crowdfunding';
        ...
        CrowdfundingProduct::query()
            ...
            ->each(function (CrowdfundingProduct $crowdfunding) {
                ...
                if ($crowdfunding->target_amount > $crowdfunding->total_amount) {
                    ...
                    //否则调用众筹成功逻辑
                    $this->crowdfundingSucced($crowdfunding);
                }
            });
    }

    protected function crowdfundingSucced(CrowdfundingProduct $crowdfunding)
    {
        //只需将众筹状态改为众筹成功即可
        $crowdfunding->update([
